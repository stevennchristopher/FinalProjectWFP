...
(1, 'Standar', 10, 1, 2, NULL),
(2, 'Double Room', 20, 2, 2, NULL),
(3, 'Suite', 30, 3, 3, NULL),
(4, 'Superior', 40, 4, 4, NULL),
(5, 'President', 50, 5, 5, NULL),
(11, 'Single Room', 10, 5, 5, NULL),
(13, 'Suite', 30, 3, 3, NULL),
(14, 'Deluxe', 40, 6, 8, NULL),
(15, 'Family Room', 50, 1, 1, NULL),
(16, 'Single Room', 40, 2, 3, NULL);
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_tipeproduk_id_foreign` FOREIGN KEY (`tipeproduk_id`) REFERENCES `products` (`id`);
